...
APP_BG_PATH = r"C:\Users\Muhammd Reyyan\Desktop\Python\AppBG.png"  # ✅ fixed path
# ---------------------------------------
...
class ModernButton(tk.Canvas):
    def __init__(self, parent, text, command=None, width=260, height=55,
                 bg1="#004b88", bg2="#002648", fg="white", radius=30, **kwargs):
...
# ---- Weather Result Card ----
result_frame = tk.Frame(root, bg="#121212", bd=0, highlightthickness=0)
